class ManageIQ::Providers::Foreman::Inventory::Persister::ConfigurationManager < ManageIQ::Providers::Foreman::Inventory::Persister
  def initialize_inventory_collections
    add_configuration_collection(:configuration_profiles)
    add_configuration_collection(:configured_systems)
  ...
  def add_configuration_collection(collection)
    add_collection(configuration, collection)
  end
